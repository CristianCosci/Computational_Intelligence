...
class ACO_for_TSP:
    def __init__(self, problem):
        ...
        self.alpha = 1  #feromone
        self.beta = 1   #euristica
        self.rho = 0.1
        self.tau0 = 0.9
        self.n_ants = 20
    ...
    def run(self, num_gen, seed = 0):
        ...
        for g in range(1, num_gen+1):
            for n in range(0, self.n_ants):
                self.sol[n] = self.generate_solutions()
    ...
    def generate_solutions(self):
        ...
        current = self.n_cities # a non existing city, it means that it must choose
    ...
    def update_pheromone(self):
        self.evaporate()
        #self.reward(self.best_so_far, self.w_bs/self.bs_cost)
